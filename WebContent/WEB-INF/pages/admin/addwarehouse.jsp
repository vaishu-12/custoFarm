...
<h3  align="center"><span class="label label-default">WareHouse Registration</span></h3>
<br><br>
	<form:form method="post" action="addwarehouse" modelAttribute="warehouse">
		<table class="table">
			<tr>
				<td style="color:white">WareHouse Name</td>
				<td><form:input  path="warehouseName" required="required"/></td>	
			</tr>
			<tr>
